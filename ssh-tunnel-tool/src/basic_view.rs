...
impl BasicView {
	...
	let mut fl2rust_widget_2 = Frame::new(215, 25, 40, 20, "Type");
	fl2rust_widget_0.add(&fl2rust_widget_2);
	let mut fl2rust_widget_3 = Frame::new(280, 25, 70, 20, "Start/Stop");
	fl2rust_widget_0.add(&fl2rust_widget_3);
	let mut fl2rust_widget_4 = Frame::new(350, 24, 80, 20, "Forward port");
	fl2rust_widget_0.add(&fl2rust_widget_4);
	let mut fl2rust_widget_5 = Frame::new(445, 25, 80, 20, "Dst host:port");
	fl2rust_widget_0.add(&fl2rust_widget_5);
	let mut fl2rust_widget_6 = Frame::new(840, 25, 65, 20, "password");
	fl2rust_widget_0.add(&fl2rust_widget_6);
	let mut fl2rust_widget_7 = Frame::new(558, 25, 260, 20, "username @@ssh_server_ip : ssh_port");
	...
	let mut forward_type_choice = Choice::new(200, 60, 75, 24, None);
	...
	let mut start_btn = Button::new(290, 59, 24, 24, None);
	...
	let mut stop_btn = Button::new(315, 59, 24, 24, None);
	...
	let mut ssh_username_iuput = Input::new(552, 60, 78, 24, None);
